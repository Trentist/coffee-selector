...
/**
 * Display Service Test - اختبار خدمة العرض
 * اختبار شامل لخدمة العرض الجديدة مع جميع الاستعلامات
 */
...
// ============================================================================
// CATEGORY TESTS - اختبارات الفئات
// ============================================================================
...
// ============================================================================
// PRODUCT TESTS - اختبارات المنتجات
// ============================================================================
...
async function testGetProductsByCategory(categoryId) {
	...
	// Use the category query to get products
	const query = `
	...
	try {
		...
		if (result.data?.category?.products) {
			...
			console.log(`📂 الفئة: ${categoryName}`);
			console.log(`📦 المنتجات المتاحة: ${products.length}`);
...
async function runDisplayServiceTest() {
	console.log("🚀 اختبار خدمة العرض الشاملة");
	...
	try {
		...
		// Final Summary
		console.log("\n" + "=".repeat(70));
		console.log("🎯 النتائج النهائية لاختبار خدمة العرض");
		console.log("=".repeat(70));
		...
		if (successRate >= 80) {
			console.log("\n🎉 ممتاز! خدمة العرض تعمل بشكل مثالي");
			console.log("✨ جميع الاستعلامات تعمل والبيانات متاحة");
		...
		console.error("❌ خطأ في اختبار خدمة العرض:", error.message);
...
if (require.main === module) {
	runDisplayServiceTest()
		.then((results) => {
			console.log("\n✅ اكتمل اختبار خدمة العرض بنجاح!");
			console.log("🎊 الخدمة جاهزة للاستخدام مع جميع البيانات!");
			process.exit(0);
		})
		.catch((error) => {
			console.error("❌ فشل اختبار خدمة العرض:", error.message);
			process.exit(1);
		});
}

module.exports = { runDisplayServiceTest };
